    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        getDominantColorFromImage(imageUrl, (newColorValues) => {
            ...
            document.documentElement.style.setProperty('--primary', newColorValues);
            const glowColor = newColorValues.replace(/ /g, ', ');
            document.documentElement.style.setProperty('--primary-glow', glowColor);

            toast({
              title: "Vibe Synced",
              description: "Your aesthetic has been updated across the sphere.",
            });
        });
      };
